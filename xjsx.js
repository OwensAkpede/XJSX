  ...
  var KEYWORD = "keyword";
   ...
   var __core__ = {
      ...
      dispatcher: function(win,name) {
         !__core__.dispatcher_init&&(__core__.dispatcher_init = document.createEvent("Event"))
...
//console.log(crt);
     ...
     foo.prototype = {};
    */
        var o = this.CALLBACK_PROTOTYPE(crt, "onend"===opt&&"callback"||opt, node);
...
*/
  ...
  __core__.createModule([
    {
      ...
      callback: function (e, currentProcess, core) {
       /* if (currentProcess&&currentProcess.isDeadProcess) {
        ...
        currentProcess&&(
      !currentProcess.isDeadProcess&&!core.execCallback(currentProcess)&&
      ...
      try{
          argument = [
           Object.assign(http.response,{
              ...
              get response(){
                console.warn(self.parentParams.join(":")+"\nthen:"+p[0]+".response this function is now deprecated");
  ...
  console.error(self.parentParams.join(':')+"\nresponse could not be converted to "+http.responseType+" type" );
}
             http.abort();
          ...
          try{
            ...
            console.error(self.parentParams.join(':')+"...then:", p.join(","), err + "");
          }
      ...
      callback: function (p) {
       ...
       //   console.error(arguments[0]);
          ...
          try {
            ...
            console.error(self.parentParams.join(':')+"...catch:", p.join(","), err + "");
          }
          http = delete self.global.http;
  ...
  __core__.createModule([
    {
      ...
      callback: function (url) {
       ...
       /*if (!http.response) {
         ...
         self.putChild(__core__.XJSXCompiler(__core__.domParser(http.response,http.abort()),self.eval).childNodes)
        });
