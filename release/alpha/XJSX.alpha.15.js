...
/***
  ...
  return [eval(`var ${arguments[1]} =arguments[0]`,arguments[0]=arguments[1]=void 0),eval("("+arguments.callee+")")]
  }else{
  return [eval(arguments[0],arguments[0]=arguments[1]=void 0),eval("("+arguments.callee+")")]
  }
}
...
// _eval=_eval()
 ...
 var ev=new __core__._eval();
  ev=ev.eval;
  ev("var a=5");
(function(argument) {
 var _ev=new __core__._eval(ev());
  _ev=_ev.eval
  //console.log(ev);
  _ev("var b=5")
  _ev("console.log(b)");
...
//console.log(eval("console.log(_ev)"));


  return 
  ({__proto__:__core__,eval:eval})._observer(document);
