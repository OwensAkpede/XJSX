  ...
  return 
    ...
    XJSXHandlers = {
      processKeyword: function (e, currentProcess) {
        ...
        var isNewProcess;
        var module = currentProcess&&currentProcess.process.module.keywords.hasOwnProperty(params[0])
 ?void 0:core.getModule(params[0]);
...
//}
        ...
        if (!module ) {
           console.error("Unexpected token '%s' (%s:%s)",params[0],params[0],params[1]);
          return;
        }
  ...
  core.createModule([
    {
      keyword: "if",
      onprogress:function(e,eval,node) {
           console.log(node);
      },
      onload: function (q) {
      //  console.log(q);
    ...
    // console.log(this);
      ...
      callback: function (q) {
        if (this.global.else) {
          return console.error("(else:"+q+") this process should be removed"+"")
        }
        this.terminate()
                  //
                // console.log(q);
