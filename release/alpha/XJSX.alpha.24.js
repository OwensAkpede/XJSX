...
(function (exec) {
  ...
  var __core__ = {
            ...
            //   }
              for (var i = 0; i < e.length; i++) {
                ...
                for (var _i = 0; _i < record.addedNodes.length; _i++) {
                  ...
                  if
                  (!n.parentNode||n.fromXJSXCore||n.parentNode.removed||n.parentNode._removed)
                  {
    ...
    stage: function (e) {
   //   if (e.type==="xjsx"&&e instanceof HTMLScriptElement) {
    //    this.eval(e.innerHTML)
    //  }
 ...
 // console.log(node,node.textContent);
  ...
  //  }
         ...
         _this.delete=function() {node.expired=true}
      //   _this.delete=
         _this.disable= function() {}
       }
      }
        ...
        self = {
          ...
          append: function (e, shouldProcess) {
            ...
            if (self.removed) {
             ...
             if (len>=0&& nodes[len].expired) {
               console.log(nodes[len].textContent);
             }
           //   len>=0&&nodes[len].expired&&(nodes[len].remove(),nodes.pop);
              nodes.push(e);
            }
          },
          forEach: function (f) {
