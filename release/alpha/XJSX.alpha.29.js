  ...
  var KEYWORD = "keyword",
    ...
    _observer:window.MutationObserver
      ...
      : function (elm) {
         ...
         console.warn("now manually parse this document with the \"onload\" event.");
         addEventListener("load",function() {
    ...
    modules: {},
    moduleType: [KEYWORD, METHOD, FUNCTION, FKEYWORD],
    signedKeywords: {},
    moduleLength: 0,
     ...
     /*   if (core.id) {*/
       /*  _this.appendTo=function(doc) {
           ...
           // body...
            ...
            return (node.removed = true),doc.appendChild(node);
         }*/
...
//console.log(node.process);
      ...
      var nodes = [],
        ...
        forEach = function (a) {
          if (a instanceof Array) {
            ...
            foo(a),
          a.process&&a.process.nodes.forEach&&a.process.nodes.forEach(forEach);
    ...
    XJSXProcessor: function (e, currentProcess) {
      ...
      var shouldProcess = currentProcess && currentProcess.isDeadProcess ? 0 : 1;
  ...
  __core__.createModule([
    {
      ...
      callback: function (tmp, node, eval) {
        ...
        try {
          ...
          if (original) {
          node.putChild(__core__.XJSXCompiler(tmp, eval));
          }else{
